...
function importMembers() {
  ...
  return rows.map((r) => ({
    ...
    top_outside_state_1_amt: toNumber(r.top_outside_state_1_amt) ?? 0,
    top_outside_state_2: r.top_outside_state_2 || "",
    top_outside_state_2_amt: toNumber(r.top_outside_state_2_amt) ?? 0,
    top_outside_state_3: r.top_outside_state_3 || "",
    top_outside_state_3_amt: toNumber(r.top_outside_state_3_amt) ?? 0,
